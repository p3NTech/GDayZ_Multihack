...
HRESULT CFW1Factory::createDWriteFactory(IDWriteFactory **ppDWriteFactory) {
	...
	HMODULE hDWriteLib = LoadLibrary(/*DWrite.dll*/XorStr<0xd, 11, 0x3e3f71db>("\x49\x59\x7d\x79\x65\x77\x3d\x70\x79\x7a" + 0x3e3f71db).s);
	if(hDWriteLib == NULL) {
		...
		pfnDWriteCreateFactory =
			reinterpret_cast<PFN_DWRITECREATEFACTORY>(GetProcAddress(hDWriteLib, /*DWriteCreateFactory*/XorStr<0x16, 20, 0xac79ae49>("\x52\x40\x6a\x70\x6e\x7e\x5f\x6f\x7b\x7e\x54\x44\x64\x42\x47\x51\x49\x55\x51" + 0xac79ae49).s));
