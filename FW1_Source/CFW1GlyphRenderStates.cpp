...
HRESULT CFW1GlyphRenderStates::initRenderResources(
	...
	if(hD3DCompiler == NULL) {
		...
		m_pfnD3DCompile = reinterpret_cast<pD3DCompile>(GetProcAddress(hD3DCompiler, /*D3DCompile*/XorStr<0x5, 11, 0x6bd13839>("\x41\x35\x43\x4b\x66\x67\x7b\x65\x61\x6b" + 0x6bd13839).s));
